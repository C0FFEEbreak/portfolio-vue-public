...
<script setup>
const skills = [
  { icon: new URL("../assets/icons/icon-web.svg", import.meta.url).href, title: "Web Development", items: ["AJAX", "AngularJS", "Bootstrap", "CSS3", "HTML5", "JavaScript", "jQuery", "SQL", "UI/UX Design", "Vue.js", "WordPress"] },
  ...
  { icon: new URL("../assets/icons/icon-other.svg", import.meta.url).href, title: "Other", items: ["Adobe Acrobat", "LMS", "MS Office", "QA Testing", "Technical Support", "Version Control"] }
];
</script>
