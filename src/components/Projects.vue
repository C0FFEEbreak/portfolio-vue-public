      ...
      projects: [
        {
          ...
          description:
            "A fully responsive multiple choice quiz application with accessiblity in eLearning.",
          tech: ["html", "css", "react"],
        },
        {
          ...
          description:
            "The app includes dynamic lists, task scoring and progress totals for user travel planning.",
          tech: ["html", "css", "react"],
        },
        {
          ...
          description:
            "Interactive image with clickable hotspots revealing hidden content for eLearning students.",
          tech: ["html", "css", "js"],
        },
        {
          ...
          description:
            "Click-to-reveal activity with interactive content elements for eLearning courses.",
          tech: ["html", "css", "js"],
        },
        {
          ...
          description:
            "A responsive website with service showcase and contact information.",
          tech: ["html", "css", "react"],
        },
        {
          ...
          description:
            "Interactive todo app with progress tracking, autosave, and data fetching display.",
          tech: ["html", "css", "react"],
        },
      ],
    };
...
.project-card:nth-child(3n + 1).is-visible {
  transition-delay: 0ms;
}
.project-card:nth-child(3n + 2).is-visible {
  transition-delay: 100ms;
}
.project-card:nth-child(3n + 3).is-visible {
...
@media (max-width: 900px) {
  ...
  .project-card:nth-child(2n + 1).is-visible {
    transition-delay: 0ms;
  }
  .project-card:nth-child(2n + 2).is-visible {
    transition-delay: 100ms;
  }
